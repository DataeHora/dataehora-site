 ...
 * The officialTimeOffset corrects for system clock drift (from WorldTimeAPI sync)
 * The formatters handle timezone display (timeZone: 'America/Sao_Paulo')
 * @returns {Date} Current Date object with drift correction
 */
